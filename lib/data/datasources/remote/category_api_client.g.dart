...
class _CategoryApiClient implements CategoryApiClient {
  _CategoryApiClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<List<CategoryResponse>> getCategories({bool? isActive}) async {
  ...
  @override
  Future<List<CategoryResponse>> getCategoriesWithCount() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
